...
Namespace CodedUITestProject5
    ...
    Partial Public Class UIMap
        ...
        Public Sub RecordedMethod1()
            ...
            Mouse.Click(uIProject7exeярлыкListItem, New Point(45, 27))

            'Правая-Щелкните "Project7.exe — ярлык" элемент списка
            Mouse.Click(uIProject7exeярлыкListItem, MouseButtons.Right, ModifierKeys.None, New Point(45, 27))

            'Двойной щелчок "Project7.exe — ярлык" элемент списка
            Mouse.DoubleClick(uIProject7exeярлыкListItem, New Point(34, 19))
            ...
            'Щелкните "Ввести" кнопка
            Mouse.Click(uIВвестиButton, New Point(7, 12))

            'Выберите "300" в "numericUpDown1" поле со списком
            uINumericUpDown1ComboBox.EditableItem = Me.RecordedMethod1Params.UINumericUpDown1ComboBoxEditableItem5

            'Щелкните "Ввести" кнопка
            Mouse.Click(uIВвестиButton, New Point(11, 7))

            'Выберите "301" в "numericUpDown1" поле со списком
            uINumericUpDown1ComboBox.EditableItem = Me.RecordedMethod1Params.UINumericUpDown1ComboBoxEditableItem6

            'Щелкните "Ввести" кнопка
            Mouse.Click(uIВвестиButton, New Point(14, 9))

            'Выберите "302" в "numericUpDown1" поле со списком
            uINumericUpDown1ComboBox.SelectedItem = Me.RecordedMethod1Params.UINumericUpDown1ComboBoxSelectedItem

            'Щелкните "Ввести" кнопка
            Mouse.Click(uIВвестиButton, New Point(15, 8))

            'Выберите "303" в "numericUpDown1" поле со списком
            uINumericUpDown1ComboBox.SelectedItem = Me.RecordedMethod1Params.UINumericUpDown1ComboBoxSelectedItem1

            'Щелкните "Ввести" кнопка
            Mouse.Click(uIВвестиButton, New Point(29, 12))

            'Выберите "304" в "numericUpDown1" поле со списком
            uINumericUpDown1ComboBox.SelectedItem = Me.RecordedMethod1Params.UINumericUpDown1ComboBoxSelectedItem2

            'Щелкните "Ввести" кнопка
            Mouse.Click(uIВвестиButton, New Point(19, 12))

            'Выберите "305" в "numericUpDown1" поле со списком
            ...
            'Выберите "306" в "numericUpDown1" поле со списком
            uINumericUpDown1ComboBox.SelectedItem = Me.RecordedMethod1Params.UINumericUpDown1ComboBoxSelectedItem4

            'Щелкните "Ввести" кнопка
            Mouse.Click(uIВвестиButton, New Point(1, 10))

            'Щелкните "Удалить последний" кнопка
            Mouse.Click(uIУдалитьпоследнийButton, New Point(20, 9))

            'Щелкните "Ввести" кнопка
            Mouse.Click(uIВвестиButton, New Point(29, 9))

            'Щелкните "Ввести" кнопка
            Mouse.Click(uIВвестиButton, New Point(29, 9))

            'Щелкните "ОК" кнопка
            Mouse.Click(uIОКButton, New Point(31, 5))

            'Щелкните "Посчитать" кнопка
            Mouse.Click(uIПосчитатьButton, New Point(20, 13))

            'Щелкните "Очистить все" кнопка
            Mouse.Click(uIОчиститьвсеButton, New Point(49, 10))
        End Sub
    ...
    Public Class RecordedMethod1Params
        ...
        '''Выберите "7777777" в "numericUpDown1" поле со списком
        '''</summary>
        Public UINumericUpDown1ComboBoxEditableItem1 As String = "7777777"
        
        '''<summary>
        '''Выберите "45" в "numericUpDown1" поле со списком
        '''</summary>
        Public UINumericUpDown1ComboBoxEditableItem2 As String = "45"
        
        '''<summary>
        '''Выберите "-45" в "numericUpDown1" поле со списком
        '''</summary>
        Public UINumericUpDown1ComboBoxEditableItem3 As String = "-45"
        
        '''<summary>
        '''Выберите "0" в "numericUpDown1" поле со списком
        '''</summary>
        Public UINumericUpDown1ComboBoxEditableItem4 As String = "0"
        
        '''<summary>
        '''Выберите "300" в "numericUpDown1" поле со списком
        '''</summary>
        Public UINumericUpDown1ComboBoxEditableItem5 As String = "300"
        
        '''<summary>
        '''Выберите "301" в "numericUpDown1" поле со списком
        '''</summary>
        Public UINumericUpDown1ComboBoxEditableItem6 As String = "301"
        
        '''<summary>
        '''Выберите "302" в "numericUpDown1" поле со списком
        '''</summary>
        Public UINumericUpDown1ComboBoxSelectedItem As String = "302"
        
        '''<summary>
        '''Выберите "303" в "numericUpDown1" поле со списком
        '''</summary>
        Public UINumericUpDown1ComboBoxSelectedItem1 As String = "303"
        
        '''<summary>
        '''Выберите "304" в "numericUpDown1" поле со списком
        '''</summary>
        Public UINumericUpDown1ComboBoxSelectedItem2 As String = "304"
        
        '''<summary>
        '''Выберите "305" в "numericUpDown1" поле со списком
        '''</summary>
        Public UINumericUpDown1ComboBoxSelectedItem3 As String = "305"
        
        '''<summary>
        '''Выберите "306" в "numericUpDown1" поле со списком
        '''</summary>
        Public UINumericUpDown1ComboBoxSelectedItem4 As String = "306"
        #End Region
    End Class
