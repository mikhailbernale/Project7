...
Namespace CodedUITestProject8
    ...
    Partial Public Class UIMap
        ...
        Public Sub RecordedMethod1()
            ...
            Mouse.Click(uIProject7exeярлыкListItem, MouseButtons.Right, ModifierKeys.None, New Point(53, 42))

            'Щелкните "Открыть" элемент меню
            Mouse.Click(uIОткрытьMenuItem, New Point(18, 7))
            ...
            Mouse.Click(uIВвестиButton, New Point(11, 5))
            ...
            Mouse.Click(uIПосчитатьButton, New Point(5, 7))
        End Sub
