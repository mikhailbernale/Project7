...
Namespace CodedUITestProject6
    ...
    Partial Public Class UIMap
        ...
        Public Sub RecordedMethod1()
            ...
            Mouse.Click(uIВвестиButton, New Point(29, 13))
            ...
            'Щелкните "Ввести" кнопка
            Mouse.Click(uIВвестиButton, New Point(17, 13))

            'Тип "{Enter}" в "ОК" кнопка
            Keyboard.SendKeys(uIОКButton, Me.RecordedMethod1Params.UIОКButtonSendKeys, ModifierKeys.None)

            'Двойной щелчок "Ввести" кнопка
            Mouse.DoubleClick(uIВвестиButton, New Point(26, 7))
            ...
            'Двойной щелчок "Ввести" кнопка
            Mouse.DoubleClick(uIВвестиButton, New Point(42, 10))
            ...
            'Щелкните "Ввести" кнопка
            Mouse.Click(uIВвестиButton, New Point(42, 10))

            'Щелкните "Ввести" кнопка
            Mouse.Click(uIВвестиButton, New Point(42, 10))

            'Щелкните "Ввести" кнопка
            Mouse.Click(uIВвестиButton, New Point(42, 11))

            'Щелкните "Посчитать" кнопка
            Mouse.Click(uIПосчитатьButton, New Point(15, 11))

            'Щелкните "Удалить последний" кнопка
            Mouse.Click(uIУдалитьпоследнийButton, New Point(13, 14))
        End Sub
    ...
    Public Class RecordedMethod1Params
        ...
        '''Выберите "777" в "numericUpDown1" поле со списком
        '''</summary>
        Public UINumericUpDown1ComboBoxEditableItem2 As String = "777"
        #End Region
    End Class
